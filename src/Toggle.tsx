...
const Toggle = React.forwardRef<
  HTMLInputElement,
  ToggleProps & PropsWithChildren
>(({ defaultChecked, disabled, children }, ref) => {
  return disabled ? (
    <label className="relative inline-flex items-center cursor-not-allowed">
      ...
      />
      <div className="w-11 h-6 bg-gray-bg peer-focus:outline-none border-2 border-gray-outline peer-focus:ring-2 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-outline after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gray-bg"></div>
